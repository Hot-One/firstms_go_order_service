...
type UserServiceClient interface {
	...
	GetList(ctx context.Context, in *UserGetListRequest, opts ...grpc.CallOption) (*UserGetListResponse, error)
	Update(ctx context.Context, in *UserUpdate, opts ...grpc.CallOption) (*User, error)
	Patch(ctx context.Context, in *UserUpdatePatch, opts ...grpc.CallOption) (*User, error)
...
func (c *userServiceClient) GetList(ctx context.Context, in *UserGetListRequest, opts ...grpc.CallOption) (*UserGetListResponse, error) {
...
func (c *userServiceClient) Patch(ctx context.Context, in *UserUpdatePatch, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/user_service.UserService/Patch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	GetList(context.Context, *UserGetListRequest) (*UserGetListResponse, error)
	Update(context.Context, *UserUpdate) (*User, error)
	Patch(context.Context, *UserUpdatePatch) (*User, error)
...
func (UnimplementedUserServiceServer) GetList(context.Context, *UserGetListRequest) (*UserGetListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetList not implemented")
}
func (UnimplementedUserServiceServer) Update(context.Context, *UserUpdate) (*User, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedUserServiceServer) Patch(context.Context, *UserUpdatePatch) (*User, error) {
...
func _UserService_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetList(ctx, req.(*UserGetListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_Patch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.UserService/Patch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Patch(ctx, req.(*UserUpdatePatch))
	}
	return interceptor(ctx, in, info, handler)
}
